...
urlpatterns = patterns('',
    ...
    url(r'^person/(?P<person_id>[0-9]+)/[a-zA-Z\-]+/?$','day.views.person',name='person'),
    ...
    url(r'^themonth/(?P<dt>[0-9\-]+)/$','day.views.themonth', name='themonth'),
    url(r'^theyear/(?P<dt>[0-9\-]+)/$','day.views.theyear', name='theyear'),
    url(r'^themonth/?$','day.views.themonth', name='themonth'),
    url(r'^theyear/?$','day.views.theyear', name='theyear'),
    url(r'^prevmonth/(?P<dt>[0-9\-]+)/$','day.views.previous_month', name='previous-month'),
    url(r'^prevmonth/?$','day.views.previous_month', name='previous-month'),
    url(r'^prevyear/(?P<dt>[0-9\-]+)/$','day.views.previous_year', name='previous-year'),
    ...
    url(r'^ajax/get_common_measurements/$','day.ajax_views.ajax_get_common_measurements',name='ajax_get_common_measurements'),
