...
urlpatterns = patterns('',
    ...
    url(r'photo_passthrough/(?P<id>[0-9]+).jpg$','tracker.day.photoviews.photo_passthrough',name='photo_passthrough'),
    url(r'photo_thumb_passthrough/(?P<id>[0-9]+).jpg$','tracker.day.photoviews.photo_thumb_passthrough',name='photo_thumb_passthrough'),
