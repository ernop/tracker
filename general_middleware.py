class PatchDebugMiddleware(object):
    def __init__(self):
        try:
            from django.views import debug
        except ImportError:
            return None
        debug.TECHNICAL_500_TEMPLATE = NEW_TECHNICAL_500_TEMPLATE
        debug.TECHNICAL_500_TEXT_TEMPLATE=NEW_TECHNICAL_500_TEXT_TEMPLATE

NEW_TECHNICAL_500_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
...
{% endif %}
<tr><th>Request User<td>{{request.user}}</tr>
{% if exception_type %}
    <tr>
...
NEW_TECHNICAL_500_TEXT_TEMPLATE = """{% firstof exception_type 'Report' %}{% if request %} at {{ request.path_info }}{% endif %}
